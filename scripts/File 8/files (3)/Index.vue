...
import { FilePlus2, Eye, Download, CheckCircle2, XCircle, Clock3, FileText, TrendingUp, Calendar } from 'lucide-vue-next';
                            ...
                            >
                                ...
                                <td class="px-5 py-3.5">
                                    <div class="flex items-center justify-end gap-1.5">
                                        <Link :href="`/admin/surat/${item.id}`" class="grid size-7 place-items-center rounded-lg bg-slate-100 text-slate-500 hover:bg-slate-200 transition-colors">
                                            <Eye class="size-3.5" />
                                        </Link>
                                        <a v-if="item.status === 'finished'" :href="`/admin/surat/${item.id}/download`" class="grid size-7 place-items-center rounded-lg bg-indigo-50 text-indigo-600 hover:bg-indigo-100 transition-colors">
                                            <Download class="size-3.5" />
                                        </a>
                                        <button v-if="['pending','validated_admin'].includes(item.status)" type="button" class="grid size-7 place-items-center rounded-lg bg-emerald-50 text-emerald-600 hover:bg-emerald-100 transition-colors">
