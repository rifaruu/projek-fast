...
import {
    LayoutDashboard, FilePlus2, History, Download,
...
const navGroups = computed(() => [
    {
        ...
        items: [
            ...
            { key: 'submit',    label: 'Ajukan Surat',  href: '/fast/user/ajukan',    icon: FilePlus2 },
            { key: 'history',   label: 'Riwayat',       href: '/fast/user/history',   icon: History },
        ] as NavItem[],
    },
]);
            ...
            :class="sidebarExpanded ? 'w-56' : 'w-[60px]'">
                ...
                <div class="shrink-0 border-t border-slate-100 px-2 py-2">
                    <Link href="/settings/profile"
                        ...
                        :title="!sidebarExpanded ? 'Profil' : undefined">
                        <User class="size-4 shrink-0 text-slate-400" />
                        <span v-if="sidebarExpanded">Profil Saya</span>
                    </Link>
                    <button type="button"
            ...
            <div class="shrink-0">
                <Transition name="flash">
                    <div v-if="flashSuccess"
                        ...
                        <div class="flex size-5 shrink-0 items-center justify-center rounded-full bg-emerald-500">
                ...
                <Transition name="flash">
                    <div v-if="flashError"
                        ...
                        <div class="flex size-5 shrink-0 items-center justify-center rounded-full bg-red-500">
