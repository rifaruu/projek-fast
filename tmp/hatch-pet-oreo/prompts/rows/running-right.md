Create one horizontal animation strip for Codex pet `oreo`, state `running-right`.
...
Identity: same pet in every frame: Black-and-white cat pet, rounded head, expressive eyes, white muzzle and chest, black ears and back, compact whole-body silhouette, no accessories, mascot-safe, readable at small size.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
